 ...
 * job (a message listener, in this variant). Knows nothing about how it got
 * here — same contract whether the trigger is RabbitMQ, SQS or an in-process
 * executor.
 */
@Service
public class OnboardingWorker {
    ...
    /**
     * Runs all creation steps. Any unexpected error is caught and marks the job FAILED.
     * Returning normally vs throwing lets the messaging listener decide ack/nack.
     */
